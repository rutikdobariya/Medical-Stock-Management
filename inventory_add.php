          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">ADD MEDICINE DETAILS</h6>
              </div>
              <div class="card-body">
                <form action="inventory_addSave.php" method=" post">
                    ...
                    <table id="dataTable" width="80%" cellspacing="0" cellpadding="20" align="center">
                      <tbody>
                        <tr align="center">
                          ...
                          <td><input type="number" class="form-control form-control-user" name="medicine_code" required></td>

                          <th style=" font-size: 1.2rem;">Medicine Name</th>
                          <td><input type="text" class="form-control form-control-user" name="medicine_name" required></td>
                        </tr>

                        <tr align="center">
                          <th style="font-size: 1.2rem;">Medicine Price</th>
                          <td><input type="number" class="form-control form-control-user" name="medicine_price" required></td>

                          <th style=" font-size: 1.2rem;">Medicine Quantity</th>
                          <td><input type="text" class="form-control form-control-user" name="medicine_quantity" required></td>
                        </tr>

                        <tr align="center">
                          <th style=" font-size: 1.2rem;">Company Name</th>
                          <td><input type="text" class="form-control form-control-user" name="medicine_company" required></td>

          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Accordin To Current Records</h6>
              </div>
              <div class="card-body">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr align="center">
                            ...
                            <td>
                              <a class="btn btn-success btn-icon-split" href="inventory_update.php?ids=<?php echo $row['id']; ?>">
                                <span class="text">Edit</span>
                              </a>
                            </td>
                            <td>
                              <a onclick="return confirm('Are you sure? You Want To Delete Medicine.');" class="btn btn-danger deleteUserBtn" href="inventory_delete.php?ids=<?php echo $row['id']; ?>">

          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">According To Current Records</h6>
              </div>
              <div class="card-body">

                <form action="inventory_addSave.php" method=" post">
                  <div class=" table-responsive">
                    <table id="dataTable" width="100%" cellspacing="0" class="table table-bordered dataTable">
                      <tbody>
                        <tr align="center">
                          <th>Company Name</th>
                          <th>Medicine</th>
                        ...
                        ?>
                          <tr align="center">
                            ...
                            <?php
                            $query3 = "SELECT * FROM medicine WHERE id=" . $row['medicine_id'];
                            $execute = mysqli_query($conn, $query3);
                            $medicine = mysqli_fetch_array($execute);
                            ?>
                            ...
                            <td>
                              <a class="btn btn-success btn-icon-split" href="supplier_update.php?ids=<?php echo $row['id']; ?>">
                                <span class="text">Edit</span>
                              </a>
                            </td>
                            <td>
                              <a onclick="return confirm('Are you sure? You Want To Delete Supplier.');" class="btn btn-danger deleteUserBtn" href="supplier_delete.php?ids=<?php echo $row['id']; ?>">

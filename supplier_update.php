          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">UPDATE SUPPLIER DETAILS</h6>
              </div>
              <div class="card-body">
                <form action="supplier_updateSave.php" method=" POST">
                    ...
                    <table id="dataTable" width="80%" cellspacing="0" cellpadding="20" align="center">
                      <tbody>
                        <tr align="center">
                          ...
                          <td><input type="text" class="form-control form-control-user" name="company_name" value="<?php echo $row['company_name'] ?>" ?></td>

                          <th style=" font-size: 1.2rem;">Email Address</th>
                          <td><input type="email" class="form-control form-control-user" name="email" value="<?php echo $row['email'] ?>" ?></td>
                        </tr>

                        <tr align="center">
                          <th style="font-size: 1.2rem;">Contact No.</th>
                          <td><input type="number" class="form-control form-control-user" name="contact_no" value="<?php echo $row['contact_no'] ?>" ?></td>

                          <th style="font-size: 1.2rem;">Alternate Contact No.</th>
                          <td><input type="number" class="form-control form-control-user" name="alternate_contact_no" value="<?php echo $row['alternate_contact_no'] ?>" ?></td>
                        </tr>
                        <tr align="center">
                          <th style=" font-size: 1.2rem;">Address</th>
                          <td><input type="text" class="form-control form-control-user" name="company_address" value="<?php echo $row['company_address'] ?>" ?></td>

                          <th style=" font-size: 1.2rem;">Medicine</th>
                          <td>
                            <select class="btn btn-secondary dropdown-toggle" name="medicine_id" style=" width: 15rem; font-size: 1.2rem;">
                              <option class="dropdown-item" value="">Select Category</option>
                              <?php
                              include 'connection.php';

                              $query5 = "SELECT * FROM medicine";
                              $result5 = mysqli_query($conn, $query5);

                              while ($row5 = mysqli_fetch_array($result5)) {
                                // echo $row5['medicine_name'];
                                // echo $row['medicine_name'];
                                if ($row5['id'] == $row['medicine_id']) {
                              ?>
                                  <option class="dropdown-item" value="<?php echo $row5['id']; ?>" selected><?php echo $row5['medicine_name']; ?></option>
                                <?php } else { ?>
                                  <option class="dropdown-item" value="<?php echo $row5['id']; ?>"><?php echo $row5['medicine_name']; ?></option>
                              <?php
                                }
                              } ?>
                            </select>
                        ...
                        <tr align="center">
                          <td colspan="4"><input type="submit" value="ADD SUPPLIER" class="btn btn-primary" name="submit" style="width: 15rem; font-size: 1.2rem;"></td>
                        </tr>

        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <form action="supplier_addSave.php" method=" POST">
                  <div class=" table-responsive">
                    <table id="dataTable" width="80%" cellspacing="0" cellpadding="20" align="center">
                      <tbody>
                        <tr align="center">
                          <th style="font-size: 1.2rem;">Company Name</th>
                          <td><input type="text" class="form-control form-control-user" name="company_name"></td>

                          <th style=" font-size: 1.2rem;">Email Address</th>
                          <td><input type="email" class="form-control form-control-user" name="email"></td>
                        </tr>

                        <tr align="center">
                          <th style="font-size: 1.2rem;">Contact No.</th>
                          <td><input type="number" class="form-control form-control-user" name="contact_no"></td>

                          <th style="font-size: 1.2rem;">Alternate Contact No.</th>
                          <td><input type="number" class="form-control form-control-user" name="alternate_contact_no"></td>
                        </tr>
                        <tr align="center">
                          <th style=" font-size: 1.2rem;">Address</th>
                          <td>
                            <textarea class="form-control form-control-user" name="company_address" cols=25 rows=5></textarea>
                          </td>
                          ...
                          <td>
                            <select class="btn btn-secondary dropdown-toggle" name="medicine_id" style=" width: 15rem; font-size: 1.2rem;">
                              ...
                              ?>
                                <option class="dropdown-item" value="<?php echo $row['id']; ?>"><?php echo $row['medicine_name']; ?></option>
                              <?php } ?>
                            </select>
